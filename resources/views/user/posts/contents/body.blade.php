<div class="row align-items-center">
    ...
    <div class="col-auto px-0">
        ...
        @if($post->likes->count() > 0)
            <button class="btn p-0" data-bs-toggle="modal" data-bs-target="#likes-list{{$post->id}}">
                {{$post->likes->count()}}
            </button>
...
{{-- the created_at field is in timestamp format(2024-9-5), to show the created_at date like Sep, 24 2024 we need to use date('M d,Y', strtotime($post->created_at)) --}}