    ...
    <div class="modal-dialog">
        <div class="modal-content border-danger">
            ...
            <div class="modal-body">
                <p class="text-dark fw-bold">Are you sure you want to hide this post? </p>
                <img src="{{$post->image}}" alt="" class="image-lg d-block me-auto">
                {{$post->description}}
            </div>
...
<div class="modal fade" id="unhide-post{{$post->id}}">
    <div class="modal-dialog">
        <div class="modal-content border-primary">
            ...
            <div class="modal-body">
                <p class="text-dark fw-bold">Are you sure you want to unhide this post? </p>
                <img src="{{$post->image}}" alt="" class="image-lg d-block me-auto">
                {{$post->description}}
            </div>
            <div class="modal-footer border-0">
